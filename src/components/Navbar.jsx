  ...
  return (
    <div className="z-50 w-full top-0 left-0 fixed">
      ...
      <div className={`flex md:flex-row border-b-2 border-[#947054] h-10`}>
        <div className="bg-[#212529] text-[#808080] flex items-center pl-2 w-full text-sm"><a href="mailto:contact@resees.com" className="text-[10px] font-semibold md:text-sm">contact@raeesmarketing.com</a></div>
